...
class DsFunction1(torch.autograd.Function):
    ...
    def backward(ctx, grad_output):
        ...
        #grad_output_ = grad_output[:,:,:,:,:]*batch_size*M*height*weight*depth
        #print('grad_output', grad_output)
        #print('grad_output_',grad_output_)
...
class nnFormer_s_ds_t1ce(SegmentationNetwork):
    ...
    def __init__(self, crop_size=[128,128,128],
        ...
        super(nnFormer_s_ds_t1ce, self).__init__()
